    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SingerBranches", x => new { x.BranchId, x.SingerId });
                    table.ForeignKey(
                        name: "FK_SingerBranches_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SingerBranches_Singers_SingerId",
                        column: x => x.SingerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SingerBranches_SingerId",
                table: "SingerBranches",
                column: "SingerId");
